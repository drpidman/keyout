    ...
    <div class="d-flex flex-column gap-3 mt-4">
      ...
      ?>
        <div class="d-flex justify-content-between align-items-center p-3 border rounded">
          ...
          <div>
            <a href="/usuarios?novo-usuario=edit&id=<?= $usuario["idusuario"] ?>" class="btn fs-4"><i class="ri-pencil-line"></i></a>
            <a href="/usuarios?action=delete-user&id=<?= $usuario["idusuario"] ?>" class="btn fs-4"><i class="ri-delete-bin-2-line"></i></a>
          </div>
        </div>
      <?php endwhile ?>
    </div>
