    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php if (isset($_GET["method"]) && $_GET["method"] == "search") : ?>
                <form class="modal-body" action="<?= baseRedirect("reservas/actions.php?action=get_reserved") ?>" method="POST">
                    <div class="mb-3">
            ...
            ?>
                <?php if ($query_reservas->rowCount()) : ?>
                    <form class="modal-body" action="<?= baseRedirect("reservas/actions.php?action=confirm&redirect=") . baseRedirect("reservas") ?>" method="POST">
                ...
                <?php else : ?>
                    ...
                    <div class="modal-footer">
                        <a href="<?= baseRedirect("reservas") ?>" class="btn btn-success">Fechar</a>
                    </div>
                <?php endif ?>
            <?php endif; ?>
