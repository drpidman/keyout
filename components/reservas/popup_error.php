        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <?php if (isset($_GET["from_page"]) && $_GET["from_page"] == "change_status") : ?>
                    <a type="button" class="btn-close" href="/reservas?action=confirmar&method=change_status&user_id=<?= $_GET["user_id"] ?>"></a>
                <?php endif ?>
            ...
            <div class="modal-footer">
                <?php if (isset($_GET["from_page"]) && $_GET["from_page"] == "change_status") : ?>
                    <a type="button" class="btn btn-primary" href="/reservas?action=confirmar&method=change_status&user_id=<?= $_GET["user_id"] ?>">Fechar</a>
                <?php endif ?>
