<div class="accordion-item">
    <h2 class="accordion-header">
        <button
            ...
            type="button" data-bs-toggle="collapse" data-bs-target="#flush_<?= $reserva["idreserva"] ?>"
            aria-expanded="false" aria-controls="flush_<?= $reserva["idreserva"] ?>">
            Reserva nº
            <?= $reserva["idreserva"] ?> |
    ...
    <div id="flush_<?= $reserva["idreserva"] ?>" class="accordion-collapse collapse"
        data-bs-parent="#accordion-reserva">
